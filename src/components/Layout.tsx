...
import { Home, BookOpen, Users, BarChart3, Truck, Stethoscope, Star, Menu, X, MessageCircle, TrendingUp, Calendar, Sun, Moon, Satellite, Wrench } from "lucide-react";
...
const navItems = [
  ...
  { path: "/tools", icon: Wrench, key: "tools" as const },
